...
describe('9.3 release gate: canonical rule validation',()=>{
 ...
 it('selects highest lead-suit card only',()=>{const t=[{playerId:'1',card:c('Q','clubs')},{playerId:'2',card:c('A','hearts')},{playerId:'3',card:c('K','clubs')}];expect(getWinner(t,'clubs')?.playerId).toBe('1');});
